...
public class BaseMouseCop extends VerticalLayout {
    private String url ="BaseMouseCop.class";
...
/////////////////////////////////thymeleafkomponenter
        ...
        thymeleafContent.getElement().setProperty("innerHTML", getThymeleafTemplate(this.outSvg + this.svgWeld + CalcBase.getSvgBuffer() ));
