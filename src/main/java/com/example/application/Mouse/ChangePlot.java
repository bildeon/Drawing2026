...
public class ChangePlot {
    ...
    //    System.out.println("inn ChangePlot  ");
        ...
        if (CalcUser.getPlotType().equals("fillet")){
            facValues[6] = 0.37;
            ivalues[6] = -45;
        }
        if (CalcUser.getPlotType().equals("corner")){
            facValues[4] = 0.43;
            ivalues[4] = -45;
        }
        if ( CalcUser.getPlotType().equals("flanged")){
            facValues[4] = 0.52;
            ivalues[4] = -10;
        }
        if (CalcUser.getPlotType().equals("overlap")){
            facValues[4] = 0.51;
            ivalues[4] = -10;
        }
